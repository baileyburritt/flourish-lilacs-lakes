...
// A native "Sign in with Apple" button (distinct from this OAuth-flow
// button) is an App Store guideline 4.8 requirement once this ships to the
// App Store; tracked as a follow-up, not solved here.
  ...
  return (
    <View style={styles.screen}>
      ...
      <Pressable
        ...
        style={styles.button}
      >
        <Text style={styles.buttonText}>{pending === 'oauth_apple' ? 'Signing in…' : 'Continue with Apple'}</Text>
      </Pressable>
    </View>
  );
}
